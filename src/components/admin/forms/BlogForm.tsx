...
interface Props { data: BlogFormData; onChange: (d: BlogFormData) => void; }
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <input className={cls} value={data.url} onChange={e => set("url", e.target.value)} placeholder="https://..." />
      </div>
      ...
      <div>
        ...
        <CloudinaryUpload url={data.thumbnail ?? ""} onUpload={url => set("thumbnail", url)} folder="blog-thumbnails" />
      </div>
    </div>
  );
}
